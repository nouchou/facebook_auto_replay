...
from models import db, FacebookPage, Message
...
def create_app():
    ...
    def webhook():
        """Recevoir les notifications de Facebook - MESSAGES UNIQUEMENT"""
    ...
    def health():
        return jsonify({'status': 'healthy', 'message': 'API is running - Messages only'}), 200
...
if __name__ == '__main__':
    ...
    print('💬 Fonctionnalité: MESSAGES MESSENGER UNIQUEMENT')
    print('='*60)
